...
private:
	...
	void cleanup() {
		...
		for (size_t i = 0; MAX_FRAMES_IN_FLIGHT; i++) {
	...
	void createDepthResources() {
		...
		depthImageView = createImageView(depthImage, depthFormat, VK_IMAGE_ASPECT_COLOR_BIT, 1);
	...
	void createTextureSampler() {
		...
		sampleInfo.borderColor = VK_BORDER_COLOR_INT_OPAQUE_BLACK;
		sampleInfo.unnormalizedCoordinates = VK_FALSE;
		...
		sampleInfo.maxLod = static_cast<float>(mipLevels);
	...
	void updateUniformBuffer(uint32_t currentImage) {
		...
		ubo.view = glm::lookAt(glm::vec3(2.0f, 2.0f, 2.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0, 0.0, 1.0));
	...
	VkFormat findDepthFormat() {
		return findSupportedFormat(
			{ VK_FORMAT_D32_SFLOAT, VK_FORMAT_D24_UNORM_S8_UINT, VK_FORMAT_D24_UNORM_S8_UINT},
